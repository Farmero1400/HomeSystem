...
class DelHome extends Command
{
    ...
    {
        $command = explode(":", HomeSystem::getConfigValue("delhome_cmd"));
        ...
        if ($sender instanceof Player) {
            if (isset($args[0])) {
                if (HomeAPI::existHome($sender, $args[0])) {
                    ...
                    $sender->sendMessage(HomeSystem::getConfigReplace("delhome_msg_good"));
                } else $sender->sendMessage(HomeSystem::getConfigReplace("delhome_msg_no_exist_home"));
            } else $sender->sendMessage(HomeSystem::getConfigReplace("delhome_msg_no_home"));
        }
    }
}